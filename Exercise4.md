...
![png](Exercise4_files/Exercise4_12_1.png)
...
![png](Exercise4_files/Exercise4_14_1.png)
...
# creating boxplots for all columns with numerical data
numerical_columns = carseats.select_dtypes(include=['number']).columns


plt.figure(figsize=(15, len(numerical_columns) * 5))
for i, col in enumerate(numerical_columns, 1):
    plt.subplot(len(numerical_columns), 1, i)
    plt.boxplot(carseats[col].dropna(), vert=False)
...
![png](Exercise4_files/Exercise4_16_0.png)
...
carseats = cap_outliers_iqr(carseats, 'Sales')
carseats = cap_outliers_iqr(carseats, 'CompPrice')
carseats = cap_outliers_iqr(carseats, 'Price')

#checking on the boxplots if the outliers were capped
...
![png](Exercise4_files/Exercise4_36_0.png)
...
![png](Exercise4_files/Exercise4_40_0.png)
...
![png](Exercise4_files/Exercise4_53_0.png)
...
![png](Exercise4_files/Exercise4_55_0.png)
...
![png](Exercise4_files/Exercise4_57_0.png)
